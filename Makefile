...
scryp: src/lib/error.h src/lib/lexer.cpp src/lib/lexer.h src/lib/parser.cpp src/lib/parser.h src/lib/token.h src/scrypt.cpp src/lib/grove.h src/lib/grove.cpp
	${CXX} $(CXXFLAGS)  $^ -o $@
